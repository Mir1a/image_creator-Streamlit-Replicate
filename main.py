...
#command for start: streamlit run main.py

import streamlit as st
import replicate

# command for start apps - "streamlit run main.py"

#st.title("AI image creating")
st.markdown("# :rainbow[AI image creating]")
...
def main_page(width: int,
    ...
    if submitted:
        with st.spinner("Creating image..."):
            ...
            image = result[0]
            with st.container():
                st.image(image, caption="Картинка")
